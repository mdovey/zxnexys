...
-- Command     : write_vhdl -force -mode funcsim -rename_top audio_sigma_delta_dac_1_0 -prefix
--               audio_sigma_delta_dac_1_0_ audio_sigma_delta_dac_0_0_sim_netlist.vhdl
...
entity audio_sigma_delta_dac_1_0_sigma_delta_dac is
  port (
...
end audio_sigma_delta_dac_1_0_sigma_delta_dac;

architecture STRUCTURE of audio_sigma_delta_dac_1_0_sigma_delta_dac is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_sigma_delta_dac_1_0 is
  port (
    DACout : out STD_LOGIC;
    DACin : in STD_LOGIC_VECTOR ( 15 downto 0 );
    CLK : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of audio_sigma_delta_dac_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of audio_sigma_delta_dac_1_0 : entity is "audio_sigma_delta_dac_0_0,sigma_delta_dac,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of audio_sigma_delta_dac_1_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of audio_sigma_delta_dac_1_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of audio_sigma_delta_dac_1_0 : entity is "sigma_delta_dac,Vivado 2021.2";
end audio_sigma_delta_dac_1_0;

architecture STRUCTURE of audio_sigma_delta_dac_1_0 is
...
begin
inst: entity work.audio_sigma_delta_dac_1_0_sigma_delta_dac
     port map (
      CLK => CLK,
