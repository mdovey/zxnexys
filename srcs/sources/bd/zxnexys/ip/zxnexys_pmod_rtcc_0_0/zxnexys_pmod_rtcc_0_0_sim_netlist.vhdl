...
-- Command     : write_vhdl -force -mode funcsim -rename_top zxnexys_pmod_rtcc_0_0 -prefix
--               zxnexys_pmod_rtcc_0_0_ zxnexys_pmod_rtcc_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of zxnexys_pmod_rtcc_0_0 is
  ...
  attribute X_INTERFACE_INFO of scl_i : signal is "xilinx.com:interface:iic:1.0 iic_rtcc SCL_I";
  attribute X_INTERFACE_INFO of scl_o : signal is "xilinx.com:interface:iic:1.0 iic_rtcc SCL_O";
  attribute X_INTERFACE_INFO of scl_t : signal is "xilinx.com:interface:iic:1.0 iic_rtcc SCL_T";
  attribute X_INTERFACE_INFO of sda_i : signal is "xilinx.com:interface:iic:1.0 iic_rtcc SDA_I";
  attribute X_INTERFACE_INFO of sda_o : signal is "xilinx.com:interface:iic:1.0 iic_rtcc SDA_O";
  attribute X_INTERFACE_INFO of sda_t : signal is "xilinx.com:interface:iic:1.0 iic_rtcc SDA_T";
begin
  \^pin3_i\ <= pin3_i;
  \^pin4_i\ <= pin4_i;
  \^scl_o\ <= scl_o;
