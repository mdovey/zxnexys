...
entity zxnexys_zxnexys_status_0_0_led_segment is
  port (
    ...
    pi_accel_opt : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of zxnexys_zxnexys_status_0_0_led_segment is
  ...
  attribute SOFT_HLUTNM of \ca[0]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ca[1]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ca[2]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ca[3]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ca[4]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ca[5]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ca[6]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ca[7]_INST_0\ : label is "soft_lutpair7";
...
entity zxnexys_zxnexys_status_0_0_rgb_led is
  port (
    ...
    led_b1 : in STD_LOGIC_VECTOR ( 4 downto 0 );
    DI : in STD_LOGIC_VECTOR ( 0 to 0 );
    \_inferred__0/i__carry__0_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    led17_b : in STD_LOGIC_VECTOR ( 3 downto 0 );
    pi_accel_opt : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute ORIG_REF_NAME : string;
...
\_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(0) => \_carry_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => led_g1(1 downto 0),
      DI(1) => \_carry__0_0\(0),
      DI(0) => '0',
...
\_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(0) => \_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => led_g1(5 downto 2),
...
\_inferred__0/i__carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => led_b1(1 downto 0),
      DI(1) => DI(0),
      DI(0) => '0',
...
entity zxnexys_zxnexys_status_0_0_rgb_led_0 is
  port (
    ...
    led_b1 : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
architecture STRUCTURE of zxnexys_zxnexys_status_0_0_rgb_led_0 is
  ...
  signal led17_r_INST_0_i_2_n_0 : STD_LOGIC;
  signal led_b0 : STD_LOGIC;
  signal \^led_b1\ : STD_LOGIC_VECTOR ( 4 downto 0 );
  signal led_g0 : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \_carry__0\ : label is 35;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \_carry__0_i_10\ : label is "soft_lutpair12";
  attribute ADDER_THRESHOLD of \_carry__1\ : label is 35;
  attribute ADDER_THRESHOLD of \_inferred__0/i__carry\ : label is 35;
  attribute ADDER_THRESHOLD of \_inferred__0/i__carry__0\ : label is 35;
  attribute SOFT_HLUTNM of \clk_div[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \clk_div[2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \clk_div[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \clk_div[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \clk_div[6]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \clk_div[7]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \clk_div[8]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \i__carry_i_8\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of led16_b_INST_0 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of led16_g_INST_0 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of led17_r_INST_0_i_2 : label is "soft_lutpair15";
begin
  D(0) <= \^d\(0);
  led_b1(4 downto 0) <= \^led_b1\(4 downto 0);
...
\_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1 downto 0) => \^led_g1\(3 downto 2),
      O(3 downto 0) => \NLW__carry__0_O_UNCONNECTED\(3 downto 0),
...
\_carry__0_i_10\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"A8A8A888"
    )
        port map (
...
\_inferred__0/i__carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(0) => \_inferred__0/i__carry_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => \^led_b1\(3 downto 2),
...
led16_r_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => pi_accel_opt(0),
      I1 => \rgb_led_17/inst/clk_div_reg\(6),
      I2 => led16_r_INST_0_i_1_n_0,
      I3 => \rgb_led_17/inst/clk_div_reg\(7),
      I4 => \rgb_led_17/inst/clk_div_reg\(8),
      I5 => led16_r_0,
      O => led16_r
    );
...
led17_r_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \rgb_led_17/inst/clk_div_reg\(7),
      I4 => \rgb_led_17/inst/clk_div_reg\(8),
      I5 => led17_r_INST_0_i_1_n_0,
      O => led17_r
    );
led17_r_INST_0_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"E00000000000000E"
    )
        port map (
      I0 => peripheral_reset,
      I1 => mb_reset,
      ...
      I4 => led17_r_INST_0_i_2_n_0,
      I5 => \rgb_led_17/inst/clk_div_reg\(3),
      O => led17_r_INST_0_i_1_n_0
    );
led17_r_INST_0_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
architecture STRUCTURE of zxnexys_zxnexys_status_0_0_status_display is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \display0[0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \display0[1]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \display0[2]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \display0[3]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \display1[0]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \display1[1]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \display1[2]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \display1[3]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \display2[0]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \display2[4]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \display3[3]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \display4[1]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \display4[2]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \display5[2]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \display6[0]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \display6[1]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \display6[2]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \display6[3]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \display7[0]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \display7[1]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \display7[2]_i_2\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \display7[3]_i_1\ : label is "soft_lutpair29";
...
led16_r_INST_0_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
entity zxnexys_zxnexys_status_0_0_status_rgb_led_16_0 is
  port (
    ...
    S : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \_carry__1\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    led17_g_0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    led_b1 : in STD_LOGIC_VECTOR ( 4 downto 0 );
    DI : in STD_LOGIC_VECTOR ( 0 to 0 );
...
inst: entity work.zxnexys_zxnexys_status_0_0_rgb_led
     port map (
      ...
      \_carry__1_0\(3 downto 0) => \_carry__1\(3 downto 0),
      \_inferred__0/i__carry__0_0\(3 downto 0) => \_inferred__0/i__carry__0\(3 downto 0),
      led17_b(3 downto 0) => led17_b(3 downto 0),
      led17_g => led17_g,
...
architecture STRUCTURE of zxnexys_zxnexys_status_0_0_status is
  ...
  signal \inst/led_b0\ : STD_LOGIC;
  signal led_b1 : STD_LOGIC_VECTOR ( 7 downto 3 );
  signal led_g1 : STD_LOGIC_VECTOR ( 7 downto 2 );
  signal led_segment_0_n_0 : STD_LOGIC;
  signal led_segment_0_n_1 : STD_LOGIC;
  signal led_segment_0_n_2 : STD_LOGIC;
  signal rgb_led_16_n_11 : STD_LOGIC;
  signal rgb_led_16_n_12 : STD_LOGIC;
...
rgb_led_16: entity work.zxnexys_zxnexys_status_0_0_status_rgb_led_0_0
     port map (
      ...
      S(0) => rgb_led_16_n_14,
      clk_200 => clk_200,
      \clk_div_reg[5]\(3) => rgb_led_16_n_19,
      \clk_div_reg[5]\(2) => rgb_led_16_n_20,
      \clk_div_reg[5]\(1) => rgb_led_16_n_21,
      \clk_div_reg[5]\(0) => rgb_led_16_n_22,
      \clk_div_reg[6]\(3) => rgb_led_16_n_23,
      \clk_div_reg[6]\(2) => rgb_led_16_n_24,
      \clk_div_reg[6]\(1) => rgb_led_16_n_25,
      \clk_div_reg[6]\(0) => rgb_led_16_n_26,
      \clk_div_reg[8]\(3) => rgb_led_16_n_15,
      \clk_div_reg[8]\(2) => rgb_led_16_n_16,
      \clk_div_reg[8]\(1) => rgb_led_16_n_17,
      \clk_div_reg[8]\(0) => rgb_led_16_n_18,
      \clk_div_reg[8]_0\(0) => rgb_led_16_n_34,
      cpu_contend => cpu_contend,
      led16_b => led16_b,
      led16_g => led16_g,
      led16_r => led16_r,
      ...
      led17_b => led17_b,
      led17_r => led17_r,
      led_b1(4 downto 0) => led_b1(7 downto 3),
      led_g1(5 downto 0) => led_g1(7 downto 2),
      mb_reset => mb_reset,
      peripheral_reset => peripheral_reset,
      peripheral_reset_0(0) => rgb_led_16_n_28,
      pi_accel_opt(0) => pi_accel_opt(0)
    );
rgb_led_17: entity work.zxnexys_zxnexys_status_0_0_status_rgb_led_16_0
     port map (
      ...
      S(1) => rgb_led_16_n_13,
      S(0) => rgb_led_16_n_14,
      \_carry__0\(0) => rgb_led_16_n_28,
      \_carry__1\(3) => rgb_led_16_n_15,
      \_carry__1\(2) => rgb_led_16_n_16,
      \_carry__1\(1) => rgb_led_16_n_17,
      \_carry__1\(0) => rgb_led_16_n_18,
      \_inferred__0/i__carry__0\(3) => rgb_led_16_n_19,
      \_inferred__0/i__carry__0\(2) => rgb_led_16_n_20,
      \_inferred__0/i__carry__0\(1) => rgb_led_16_n_21,
      \_inferred__0/i__carry__0\(0) => rgb_led_16_n_22,
      led17_b(3) => rgb_led_16_n_23,
      led17_b(2) => rgb_led_16_n_24,
      led17_b(1) => rgb_led_16_n_25,
      led17_b(0) => rgb_led_16_n_26,
      led17_g => led17_g,
      led17_g_0(0) => rgb_led_16_n_34,
      led_b1(4 downto 0) => led_b1(7 downto 3),
      led_g1(5 downto 0) => led_g1(7 downto 2),
      pi_accel_opt(0) => pi_accel_opt(0)
    );
