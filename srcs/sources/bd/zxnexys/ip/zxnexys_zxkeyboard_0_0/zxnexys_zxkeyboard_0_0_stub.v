...
module zxnexys_zxkeyboard_0_0(cancel, clk_peripheral, clk_peripheral_n, 
  column, extended_keys, joy_io_mode_en, joy_left, joy_left_type, joy_right, joy_right_type, 
  joymap_we, keymap_addr, keymap_data, keymap_we, ps2_clk_i, ps2_clk_o, ps2_clk_t, ps2_data_i, 
  ps2_data_o, ps2_data_t, reset, row, spkey_buttons, spkey_function)
/* synthesis syn_black_box black_box_pad_pin="cancel,clk_peripheral,clk_peripheral_n,column[4:0],extended_keys[15:0],joy_io_mode_en,joy_left[10:0],joy_left_type[2:0],joy_right[10:0],joy_right_type[2:0],joymap_we,keymap_addr[8:0],keymap_data[7:0],keymap_we,ps2_clk_i,ps2_clk_o,ps2_clk_t,ps2_data_i,ps2_data_o,ps2_data_t,reset,row[7:0],spkey_buttons[1:0],spkey_function[10:1]" */;
  input cancel;
