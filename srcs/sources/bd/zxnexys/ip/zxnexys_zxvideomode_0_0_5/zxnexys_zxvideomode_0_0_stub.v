...
module zxnexys_zxvideomode_0_0(clk_200, clock_reset, dclk, locked, 
  mmcm_drp_daddr, mmcm_drp_den, mmcm_drp_di, mmcm_drp_do, mmcm_drp_drdy, mmcm_drp_dwe, 
  video_mode, video_mode_locked)
/* synthesis syn_black_box black_box_pad_pin="clk_200,clock_reset,dclk,locked,mmcm_drp_daddr[6:0],mmcm_drp_den,mmcm_drp_di[15:0],mmcm_drp_do[15:0],mmcm_drp_drdy,mmcm_drp_dwe,video_mode[2:0],video_mode_locked" */;
  input clk_200;
  output clock_reset;
  output dclk;
  input locked;
