...
module zxnexys_zxreset_0_0(mb_reset, reset_hard, reset_soft, 
  reset_peripheral, clk_ui, clk_peripheral, io_resetn, bus_resetn, hard_resetn, soft_resetn)
/* synthesis syn_black_box black_box_pad_pin="mb_reset,reset_hard,reset_soft,reset_peripheral,clk_ui,clk_peripheral,io_resetn,bus_resetn,hard_resetn,soft_resetn" */;
  output mb_reset;
  input reset_hard;
  input reset_soft;
