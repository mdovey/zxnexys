...
o_reset_inv_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
architecture STRUCTURE of \zxnexys_zxreset_0_0_held_reset__parameterized0\ is
  ...
  signal i_reset01_out : STD_LOGIC;
...
o_reset_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\o_reset_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\o_reset_i_5__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
begin
hard_rst_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DFFF"
    )
        port map (
...
hard_rst_reg: unisim.vcomponents.FDPE
     port map (
      C => clk_peripheral,
      CE => '1',
      D => '0',
...
peripheral_rst_reg: unisim.vcomponents.FDPE
     port map (
      C => clk_peripheral,
      CE => '1',
      D => '0',
...
soft_rst_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
soft_rst_reg: unisim.vcomponents.FDPE
     port map (
      C => clk_peripheral,
      CE => '1',
      D => '0',
...
architecture STRUCTURE of zxnexys_zxreset_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of clk_peripheral : signal is "XIL_INTERFACENAME clk_peripheral, ASSOCIATED_RESET mb_reset:peripheral_reset, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zxnexys_zxclock_0_0_clk_peripheral, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of clk_ui : signal is "xilinx.com:signal:clock:1.0 clk_ui CLK";
  attribute X_INTERFACE_PARAMETER of clk_ui : signal is "XIL_INTERFACENAME clk_ui, ASSOCIATED_RESET memory_aresetn, FREQ_HZ 150015002, FREQ_TOLERANCE_HZ 0, PHASE 0, CLK_DOMAIN zxnexys_mig_7series_0_1_ui_clk, INSERT_VIP 0";
