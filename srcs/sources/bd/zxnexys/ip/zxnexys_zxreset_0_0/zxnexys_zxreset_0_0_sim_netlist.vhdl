...
\counter[16]_i_2__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55555556"
    )
        port map (
...
mb_resetn_INST_0: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\counter_reg[16]_i_1__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1 downto 0) => counter_reg(17 downto 16),
      ...
      S(1) => \counter[16]_i_3__0_n_0\,
      S(0) => \counter[16]_i_4__0_n_0\
    );
\counter_reg[17]\: unisim.vcomponents.FDPE
     port map (
      C => clk_peripheral,
...
\o_reset_i_1__0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
architecture STRUCTURE of zxnexys_zxreset_0_0_sysreset is
  ...
  signal soft_rst : STD_LOGIC;
begin
held_mb_reset: entity work.zxnexys_zxreset_0_0_held_reset
     port map (
...
held_peripheral_reset: entity work.\zxnexys_zxreset_0_0_held_reset__parameterized0\
     port map (
      clk_peripheral => clk_peripheral,
      i_reset0 => i_reset0,
...
architecture STRUCTURE of zxnexys_zxreset_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of clk_peripheral : signal is "XIL_INTERFACENAME clk_peripheral, ASSOCIATED_RESET mb_reset:mb_resetn:peripheral_reset, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zxnexys_zxclock_0_0_clk_peripheral, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_INFO of mb_resetn : signal is "xilinx.com:signal:reset:1.0 mb_resetn RST";
  attribute X_INTERFACE_PARAMETER of mb_resetn : signal is "XIL_INTERFACENAME mb_resetn, POLARITY ACTIVE_LOW, INSERT_VIP 0";
