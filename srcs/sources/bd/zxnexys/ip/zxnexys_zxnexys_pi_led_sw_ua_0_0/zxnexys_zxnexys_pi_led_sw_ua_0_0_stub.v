...
module zxnexys_zxnexys_pi_led_sw_ua_0_0(gpio_o, gpio_i, gpio_t, uart_rx, uart_tx, uart_cts, 
  uart_rts, i2s_sclk, i2s_wclk, i2s_dout, i2s_din, led, sw, opt, clk_peripheral, reset)
/* synthesis syn_black_box black_box_pad_pin="gpio_o[27:0],gpio_i[27:0],gpio_t[27:0],uart_rx,uart_tx,uart_cts,uart_rts,i2s_sclk,i2s_wclk,i2s_dout,i2s_din,led[15:0],sw[15:0],opt[1:0],clk_peripheral,reset" */;
  input [27:0]gpio_o;
  output [27:0]gpio_i;
  input [27:0]gpio_t;
  input uart_rx;
