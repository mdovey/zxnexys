...
-- Date        : Mon Dec 20 16:52:35 2021
-- Host        : AW13R3 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               v:/srcs/sources/bd/zxnexys/zxnexys/ip/zxnexys_zxjoystick_0_0/zxnexys_zxjoystick_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of zxnexys_zxjoystick_0_0_pmod_jstk2 is
  ...
  attribute SOFT_HLUTNM of \bc[0]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \bc[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \bc[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \joy_right[0]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \joy_right[1]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \joy_right[2]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \joy_right[3]_INST_0\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of sel_i_1 : label is "soft_lutpair16";
begin
...
\joy_right[0]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => x(6),
      I1 => x(5),
      I2 => \joy_right[0]_INST_0_i_1_n_0\,
      O => \^joy_right\(0)
    );
...
\joy_right[1]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
    )
        port map (
...
\joy_right[1]_INST_0_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1555FFFF"
    )
        port map (
...
\joy_right[2]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => y(6),
      I1 => y(5),
      I2 => \joy_right[2]_INST_0_i_1_n_0\,
      O => \^joy_right\(2)
    );
...
\joy_right[3]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
    )
        port map (
...
\joy_right[3]_INST_0_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1555FFFF"
    )
        port map (
...
architecture STRUCTURE of zxnexys_zxjoystick_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of clk_peripheral : signal is "XIL_INTERFACENAME clk_peripheral, ASSOCIATED_RESET reset, ASSOCIATED_BUSIF joystick, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zxnexys_zxclock_0_0_clk_peripheral, INSERT_VIP 0";
