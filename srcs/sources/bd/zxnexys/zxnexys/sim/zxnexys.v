...
(* CORE_GENERATION_INFO = "zxnexys,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zxnexys,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=24,numReposBlks=24,numNonXlnxBlks=22,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "zxnexys.hwdef" *) 
module zxnexys
   (AN,
    AUD_PWM,
    AUD_SD,
  ...
  wire zxclock_0_clk_peripheral1;
  ...
  wire [20:0]zxnext_0_mb_monitor_ram_addr;
  ...
  wire [15:0]zxnexys_led_sw_0_led;
  wire zxnexys_led_sw_0_led16_b;
  wire zxnexys_led_sw_0_led16_g;
  wire zxnexys_led_sw_0_led16_r;
  wire zxnexys_led_sw_0_led17_b;
  wire zxnexys_led_sw_0_led17_g;
  wire zxnexys_led_sw_0_led17_r;
  ...
  wire zxpi_accel_0_i2c_SCL_I;
  wire zxpi_accel_0_i2c_SCL_O;
  wire zxpi_accel_0_i2c_SCL_T;
  wire zxpi_accel_0_i2c_SDA_I;
  wire zxpi_accel_0_i2c_SDA_O;
  wire zxpi_accel_0_i2c_SDA_T;
  wire zxpi_accel_0_i2s_din;
  wire zxpi_accel_0_uart_cts;
  wire zxpi_accel_0_uart_rx;
  ...
  wire zxreset_0_peripheral_reset;
  ...
  assign LED[15:0] = zxnexys_led_sw_0_led;
  assign LED16_B = zxnexys_led_sw_0_led16_b;
  assign LED16_G = zxnexys_led_sw_0_led16_g;
  assign LED16_R = zxnexys_led_sw_0_led16_r;
  assign LED17_B = zxnexys_led_sw_0_led17_b;
  assign LED17_G = zxnexys_led_sw_0_led17_g;
  assign LED17_R = zxnexys_led_sw_0_led17_r;
  ...
  assign SW_1 = SW[15:0];
  assign UART_CTS = zxpi_accel_0_uart_cts;
  assign UART_RTS_1 = UART_RTS;
  assign UART_RXD_OUT = zxpi_accel_0_uart_rx;
  ...
  zxnexys_mig_7series_0_2 mig_7series_0
  ...
  zxnexys_zxaudio_0_0 zxaudio_0
       (.audio_left(zxnext_0_audio_left),
        ...
        .clk_peripheral(zxclock_0_clk_peripheral1),
        .linein_lrck(zxaudio_0_linein_lrck),
        .linein_mclk(zxaudio_0_linein_mclk),
        .linein_sclk(zxaudio_0_linein_sclk),
        .linein_sdin(pmod_i2s2_0_linein_sdin),
        ...
        .reset(zxreset_0_peripheral_reset),
  ...
  zxnexys_zxnext_0_0 zxnext_0
       (.i_AUDIO_EAR(zxnext_0_tape_tape_ear),
        ...
        .o_RAM_A_ADDR(zxnext_0_mb_monitor_ram_addr),
  ...
  zxnexys_zxnexys_led_sw_0_0 zxnexys_led_sw_0
       (.clk_peripheral(zxclock_0_clk_peripheral1),
        .i2c_scl_i(zxpi_accel_0_i2c_SCL_I),
        .i2c_scl_o(zxpi_accel_0_i2c_SCL_O),
        .i2c_scl_t(zxpi_accel_0_i2c_SCL_T),
        .i2c_sda_i(zxpi_accel_0_i2c_SDA_I),
        .i2c_sda_o(zxpi_accel_0_i2c_SDA_O),
        .i2c_sda_t(zxpi_accel_0_i2c_SDA_T),
        .led(zxnexys_led_sw_0_led),
        .led16_b(zxnexys_led_sw_0_led16_b),
        .led16_g(zxnexys_led_sw_0_led16_g),
        .led16_r(zxnexys_led_sw_0_led16_r),
        .led17_b(zxnexys_led_sw_0_led17_b),
        .led17_g(zxnexys_led_sw_0_led17_g),
        .led17_r(zxnexys_led_sw_0_led17_r),
        .reset(zxreset_0_peripheral_reset),
        .sw(SW_1));
  zxnexys_zxnexys_ledsegment_0_0 zxnexys_ledsegment_0
       (.address(zxnext_0_mb_monitor_ram_addr),
  ...
  zxnexys_zxnexys_mic_0_0 zxnexys_mic_0
       (.clk_audio(zxclock_0_clk_audio),
        ...
        .reset(zxreset_0_peripheral_reset));
  zxnexys_zxpi_accel_0_0 zxpi_accel_0
       (.gpio_i(zxnext_0_pi_accel_gpio_i),
        ...
        .i2s_sclk(zxnexys_mic_0_i2s_sclk),
        .i2s_wclk(zxnexys_mic_0_i2s_wclk),
        .uart_cts(zxpi_accel_0_uart_cts),
        .uart_rts(UART_RTS_1),
        .uart_rx(zxpi_accel_0_uart_rx),
  ...
  zxnexys_zxram_0_0 zxram_0
       (.axi_mig_araddr(zxram_0_axi_mig_ARADDR),
        ...
        .ram_a_addr(zxnext_0_mb_monitor_ram_addr),
  ...
  zxnexys_zxreset_0_0 zxreset_0
       (.clk_locked(clk_wiz_0_locked),
        ...
        .peripheral_reset(zxreset_0_peripheral_reset),
