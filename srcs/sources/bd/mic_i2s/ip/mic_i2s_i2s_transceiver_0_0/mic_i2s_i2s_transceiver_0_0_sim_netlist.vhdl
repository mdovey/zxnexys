...
--               v:/srcs/sources/bd/mic_i2s/ip/mic_i2s_i2s_transceiver_0_0/mic_i2s_i2s_transceiver_0_0_sim_netlist.vhdl
...
entity mic_i2s_i2s_transceiver_0_0_i2s_transceiver is
  port (
    sclk : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of mic_i2s_i2s_transceiver_0_0_i2s_transceiver : entity is "i2s_transceiver";
end mic_i2s_i2s_transceiver_0_0_i2s_transceiver;

architecture STRUCTURE of mic_i2s_i2s_transceiver_0_0_i2s_transceiver is
  ...
  signal \l_data_rx[7]_i_1_n_0\ : STD_LOGIC;
  signal l_data_rx_int : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal r_data_rx_int : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \l_data_tx_int[0]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \l_data_tx_int[7]_i_2\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \r_data_tx_int[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \r_data_tx_int[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \r_data_tx_int[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \r_data_tx_int[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \r_data_tx_int[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \r_data_tx_int[5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \r_data_tx_int[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \r_data_tx_int[7]_i_2\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of sd_tx_i_2 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of ws_int_i_1 : label is "soft_lutpair8";
begin
  sclk <= \^sclk\;
  sd_tx <= \^sd_tx\;
...
\l_data_rx[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => sclk_cnt1,
      I1 => ws_cnt1,
      O => \l_data_rx[7]_i_1_n_0\
    );
\l_data_rx_int[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
entity mic_i2s_i2s_transceiver_0_0 is
  ...
  attribute NotValidForBitStream of mic_i2s_i2s_transceiver_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of mic_i2s_i2s_transceiver_0_0 : entity is "mic_i2s_i2s_transceiver_0_0,i2s_transceiver,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of mic_i2s_i2s_transceiver_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of mic_i2s_i2s_transceiver_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of mic_i2s_i2s_transceiver_0_0 : entity is "i2s_transceiver,Vivado 2021.2";
end mic_i2s_i2s_transceiver_0_0;

architecture STRUCTURE of mic_i2s_i2s_transceiver_0_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of reset_n : signal is "xilinx.com:signal:reset:1.0 reset_n RST";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of reset_n : signal is "XIL_INTERFACENAME reset_n, POLARITY ACTIVE_LOW, INSERT_VIP 0";
begin
inst: entity work.mic_i2s_i2s_transceiver_0_0_i2s_transceiver
     port map (
      l_data_rx(7 downto 0) => l_data_rx(7 downto 0),
      l_data_tx(7 downto 0) => l_data_tx(7 downto 0),
      mclk => mclk,
      r_data_rx(7 downto 0) => r_data_rx(7 downto 0),
      r_data_tx(7 downto 0) => r_data_tx(7 downto 0),
      reset_n => reset_n,
      sclk => sclk,
      sd_rx => sd_rx,
      sd_tx => sd_tx,
