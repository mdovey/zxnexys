...
-- Date        : Sat Dec 11 13:32:14 2021
-- Host        : JL69XDHR2 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               v:/zxnext/zxrtc/zxrtc.gen/sources_1/bd/zxrtc/ip/zxrtc_rtc_0_0/zxrtc_rtc_0_0_sim_netlist.vhdl
...
entity zxrtc_rtc_0_0_rtc is
  ...
  attribute ORIG_REF_NAME of zxrtc_rtc_0_0_rtc : entity is "rtc";
end zxrtc_rtc_0_0_rtc;

architecture STRUCTURE of zxrtc_rtc_0_0_rtc is
  ...
  signal update_t_i_2_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \bcnt[10]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \bcnt[10]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \bcnt[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \bcnt[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \bcnt[5]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \bcnt[8]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \bcnt[9]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \cnt[0]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cnt[1]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cnt[3]_i_10\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cnt[3]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cnt[3]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \cnt[3]_i_7\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cnt[3]_i_9\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \ptr[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ptr[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ptr[5]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \ptr[5]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ptr[5]_i_6\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of sda_o_i_2 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of sda_o_i_6 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of update_t_i_2 : label is "soft_lutpair2";
begin
...
\bcnt[10]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\bcnt[5]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\cnt[3]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\ptr[5]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
sda_o_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"DFD0DFDFD0D0D0DF"
    )
        port map (
      I0 => sda_o_i_4_n_0,
      I1 => sda_o_reg_i_5_n_0,
      I2 => sda_o_i_6_n_0,
      I3 => \cnt[3]_i_7_n_0\,
      I4 => ack,
      I5 => \cnt[3]_i_4_n_0\,
...
update_t_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0008"
    )
        port map (
...
entity zxrtc_rtc_0_0 is
  ...
  attribute NotValidForBitStream of zxrtc_rtc_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of zxrtc_rtc_0_0 : entity is "zxrtc_rtc_0_0,rtc,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of zxrtc_rtc_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of zxrtc_rtc_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of zxrtc_rtc_0_0 : entity is "rtc,Vivado 2021.2";
end zxrtc_rtc_0_0;

architecture STRUCTURE of zxrtc_rtc_0_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_RESET reset, FREQ_HZ 28000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zxrtc_clk_peripheral, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of reset : signal is "xilinx.com:signal:reset:1.0 reset RST";
  attribute X_INTERFACE_PARAMETER of reset : signal is "XIL_INTERFACENAME reset, POLARITY ACTIVE_HIGH, INSERT_VIP 0";
begin
inst: entity work.zxrtc_rtc_0_0_rtc
     port map (
      clk => clk,
