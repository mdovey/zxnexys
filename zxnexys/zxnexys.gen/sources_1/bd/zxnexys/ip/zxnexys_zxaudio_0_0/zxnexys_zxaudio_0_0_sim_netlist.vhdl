...
--               v:/zxnext/zxnexys/zxnexys.gen/sources_1/bd/zxnexys/ip/zxnexys_zxaudio_0_0/zxnexys_zxaudio_0_0_sim_netlist.vhdl
...
entity zxnexys_zxaudio_0_0_ear is
  port (
    ear : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_ear : entity is "ear";
end zxnexys_zxaudio_0_0_ear;

architecture STRUCTURE of zxnexys_zxaudio_0_0_ear is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_mono is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_mono : entity is "mono";
end zxnexys_zxaudio_0_0_mono;

architecture STRUCTURE of zxnexys_zxaudio_0_0_mono is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_psg is
  port (
    psg_en : out STD_LOGIC;
    clk_peripheral : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_psg : entity is "psg";
end zxnexys_zxaudio_0_0_psg;

architecture STRUCTURE of zxnexys_zxaudio_0_0_psg is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_resets is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_resets : entity is "resets";
end zxnexys_zxaudio_0_0_resets;

architecture STRUCTURE of zxnexys_zxaudio_0_0_resets is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_zxaudio_ear_0_0 is
  port (
    ear : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_zxaudio_ear_0_0 : entity is "zxaudio_ear_0_0";
end zxnexys_zxaudio_0_0_zxaudio_ear_0_0;

architecture STRUCTURE of zxnexys_zxaudio_0_0_zxaudio_ear_0_0 is
begin
inst: entity work.zxnexys_zxaudio_0_0_ear
     port map (
      clk_audio => clk_audio,
      ear => ear,
      ear_reg_0 => ear_reg
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_zxaudio_i2s_transceiver_0_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_zxaudio_i2s_transceiver_0_0 : entity is "zxaudio_i2s_transceiver_0_0";
end zxnexys_zxaudio_0_0_zxaudio_i2s_transceiver_0_0;

architecture STRUCTURE of zxnexys_zxaudio_0_0_zxaudio_i2s_transceiver_0_0 is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_zxaudio_mono_0_1 is
  port (
    \l_data_rx_reg[14]\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    ear_reg : out STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 14 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_zxaudio_mono_0_1 : entity is "zxaudio_mono_0_1";
end zxnexys_zxaudio_0_0_zxaudio_mono_0_1;

architecture STRUCTURE of zxnexys_zxaudio_0_0_zxaudio_mono_0_1 is
begin
inst: entity work.zxnexys_zxaudio_0_0_mono
     port map (
      CO(0) => CO(0),
      DI(0) => DI(0),
      Q(14 downto 0) => Q(14 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_zxaudio_psg_0_0 is
  port (
    psg_en : out STD_LOGIC;
    clk_peripheral : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_zxaudio_psg_0_0 : entity is "zxaudio_psg_0_0";
end zxnexys_zxaudio_0_0_zxaudio_psg_0_0;

architecture STRUCTURE of zxnexys_zxaudio_0_0_zxaudio_psg_0_0 is
begin
inst: entity work.zxnexys_zxaudio_0_0_psg
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_zxaudio_resets_0_0 is
  port (
    AR : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_zxaudio_resets_0_0 : entity is "zxaudio_resets_0_0";
end zxnexys_zxaudio_0_0_zxaudio_resets_0_0;

architecture STRUCTURE of zxnexys_zxaudio_0_0_zxaudio_resets_0_0 is
begin
inst: entity work.zxnexys_zxaudio_0_0_resets
     port map (
      AR(0) => AR(0),
      clk_audio => clk_audio,
      reset => reset,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_zxaudio_sigma_delta_dac_0_3 is
  port (
    tape_pwm : out STD_LOGIC;
    clk_audio : in STD_LOGIC;
    AR : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_zxaudio_sigma_delta_dac_0_3 : entity is "zxaudio_sigma_delta_dac_0_3";
end zxnexys_zxaudio_0_0_zxaudio_sigma_delta_dac_0_3;

architecture STRUCTURE of zxnexys_zxaudio_0_0_zxaudio_sigma_delta_dac_0_3 is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_zxaudio is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_zxaudio : entity is "zxaudio";
end zxnexys_zxaudio_0_0_zxaudio;

architecture STRUCTURE of zxnexys_zxaudio_0_0_zxaudio is
...
begin
  ear <= \^ear\;
ear_0: entity work.zxnexys_zxaudio_0_0_zxaudio_ear_0_0
     port map (
      clk_audio => clk_audio,
      ear => \^ear\,
      ear_reg => mono_1_n_1
    );
i2s_transceiver_0: entity work.zxnexys_zxaudio_0_0_zxaudio_i2s_transceiver_0_0
     port map (
...
mono_1: entity work.zxnexys_zxaudio_0_0_zxaudio_mono_0_1
     port map (
      CO(0) => i2s_transceiver_0_n_23,
      DI(0) => i2s_transceiver_0_n_22,
      Q(14 downto 0) => l_data_rx(14 downto 0),
...
psg_0: entity work.zxnexys_zxaudio_0_0_zxaudio_psg_0_0
     port map (
      clk_peripheral => clk_peripheral,
      psg_en => psg_en
    );
resets_0: entity work.zxnexys_zxaudio_0_0_zxaudio_resets_0_0
     port map (
      AR(0) => reset_1,
      clk_audio => clk_audio,
      reset => reset,
...
sigma_delta_dac_1: entity work.zxnexys_zxaudio_0_0_zxaudio_sigma_delta_dac_0_3
     port map (
      AR(0) => reset_1,
      clk_audio => clk_audio,
      mic => mic,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxaudio_0_0_zxaudio_wrapper is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zxnexys_zxaudio_0_0_zxaudio_wrapper : entity is "zxaudio_wrapper";
end zxnexys_zxaudio_0_0_zxaudio_wrapper;

architecture STRUCTURE of zxnexys_zxaudio_0_0_zxaudio_wrapper is
begin
zxaudio_i: entity work.zxnexys_zxaudio_0_0_zxaudio
     port map (
      audio_left(12 downto 0) => audio_left(12 downto 0),
      audio_right(12 downto 0) => audio_right(12 downto 0),
      clk_audio => clk_audio,
...
entity zxnexys_zxaudio_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of zxnexys_zxaudio_0_0 : entity is "zxnexys_zxaudio_0_0,zxaudio_wrapper,{}";
  ...
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of zxnexys_zxaudio_0_0 : entity is "zxaudio_wrapper,Vivado 2021.2";
...
architecture STRUCTURE of zxnexys_zxaudio_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk_audio : signal is "XIL_INTERFACENAME clk_audio, FREQ_HZ 22580645, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of clk_peripheral : signal is "xilinx.com:signal:clock:1.0 clk_peripheral CLK";
  attribute X_INTERFACE_PARAMETER of clk_peripheral : signal is "XIL_INTERFACENAME clk_peripheral, ASSOCIATED_RESET reset, ASSOCIATED_BUSIF tape:audio, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zxnexys_zxclock_0_2_clk_peripheral, INSERT_VIP 0";
...
inst: entity work.zxnexys_zxaudio_0_0_zxaudio_wrapper
     port map (
      audio_left(12 downto 0) => audio_left(12 downto 0),
      audio_right(12 downto 0) => audio_right(12 downto 0),
      clk_audio => \^clk_audio\,
