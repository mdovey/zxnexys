...
-- Date        : Sat Dec 11 02:32:50 2021
-- Host        : JL69XDHR2 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               v:/zxnext/zxnexys/zxnexys.gen/sources_1/bd/zxnexys/ip/zxnexys_zxsdcard_0_1/zxnexys_zxsdcard_0_1_sim_netlist.vhdl
...
entity zxnexys_zxsdcard_0_1_zxsdcard is
  port (
  ...
  attribute ORIG_REF_NAME of zxnexys_zxsdcard_0_1_zxsdcard : entity is "zxsdcard";
end zxnexys_zxsdcard_0_1_zxsdcard;

architecture STRUCTURE of zxnexys_zxsdcard_0_1_zxsdcard is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zxnexys_zxsdcard_0_1 is
  port (
    sd_cd : in STD_LOGIC;
    sd_sck : out STD_LOGIC;
    sd_cmd : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of zxnexys_zxsdcard_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of zxnexys_zxsdcard_0_1 : entity is "zxnexys_zxsdcard_0_1,zxsdcard,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of zxnexys_zxsdcard_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of zxnexys_zxsdcard_0_1 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of zxnexys_zxsdcard_0_1 : entity is "zxsdcard,Vivado 2021.2";
end zxnexys_zxsdcard_0_1;

architecture STRUCTURE of zxnexys_zxsdcard_0_1 is
  signal \<const1>\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk_peripheral : signal is "xilinx.com:signal:clock:1.0 clk_peripheral CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk_peripheral : signal is "XIL_INTERFACENAME clk_peripheral, ASSOCIATED_RESET reset, ASSOCIATED_BUSIF sdcard, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zxnexys_zxclock_0_0_clk_peripheral, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of enable_n : signal is "specnext.com:specnext:sdcard_enable:1.0 sdcard_enable_n enable_n";
...
in_miso_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
inst: entity work.zxnexys_zxsdcard_0_1_zxsdcard
     port map (
