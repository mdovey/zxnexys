...
(* CORE_GENERATION_INFO = "ram,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ram,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=27,numReposBlks=21,numNonXlnxBlks=0,numHierBlks=6,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=10,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "ram.hwdef" *) 
module ram
   (axi_mig_araddr,
    axi_mig_arburst,
    axi_mig_arcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_UI CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_UI, ASSOCIATED_BUSIF axi_mig, ASSOCIATED_RESET reset_ui, CLK_DOMAIN ram_clk_ui, FREQ_HZ 150015002, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_ui;
  output cpu_wait_n;
  output [7:0]data_a_o;
  output [7:0]data_b_o;
  ...
  ram_axi_interconnect_0_1 axi_interconnect_0
       (.ACLK(clk_ui_1),
        .ARESETN(ARESETN_1),
        .M00_ACLK(clk_ui_1),
  ...
  ram_blk_mem_gen_1_0 blk_mem_gen_1
  ...
  ram_bram_write_1_0 bram_write_1
  ...
  ram_ram_a_read_0_0 ram_a_read_0
  ...
  ram_ram_a_write_0_0 ram_a_write_0
       (.AWADDR(ram_a_write_0_interface_aximm_AWADDR),
        ...
        .write_data(ram_a_write_0_write_data),
        .write_signal(ram_a_write_0_write_signal));
  ram_ram_b_read_0_0 ram_b_read_0
       (.ARADDR(ram_b_read_0_interface_aximm_ARADDR),
        ...
        .write_data(ram_a_write_0_write_data),
        .write_signal(ram_a_write_0_write_signal));
  ram_ram_b_read_1_0 ram_b_read_1
...
module ram_axi_interconnect_0_1
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
...
module s00_couplers_imp_D8U04H
  ...
  ram_s00_data_fifo_0 s00_data_fifo
       (.aclk(M_ACLK_1),
        .aresetn(M_ARESETN_1),
...
module s01_couplers_imp_1V6X9R8
  ...
  ram_s01_data_fifo_0 s01_data_fifo
       (.aclk(M_ACLK_1),
        .aresetn(M_ARESETN_1),
...
module s02_couplers_imp_M5UN3E
  ...
  ram_s02_data_fifo_0 s02_data_fifo
       (.aclk(M_ACLK_1),
        .aresetn(M_ARESETN_1),
...
module s03_couplers_imp_14MZMY7
  ...
  ram_s03_data_fifo_0 s03_data_fifo
       (.aclk(M_ACLK_1),
        .aresetn(M_ARESETN_1),
