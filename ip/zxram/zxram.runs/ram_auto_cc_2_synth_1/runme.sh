...
HD_PWD='V:/ip/zxram/zxram.runs/ram_auto_cc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_auto_cc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_auto_cc_2.tcl
