...
HD_PWD='V:/ip/zxram/zxram.runs/ram_bram_write_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_bram_write_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_bram_write_0_1.tcl
