...
HD_PWD='V:/ip/zxram/zxram.runs/ram_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_xbar_0.tcl
