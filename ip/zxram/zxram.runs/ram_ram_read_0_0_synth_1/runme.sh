...
HD_PWD='V:/ip/zxram/zxram.runs/ram_ram_read_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_ram_read_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_ram_read_0_0.tcl
