...
module audio
  ...
  output audio_sd;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_AUDIO CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_AUDIO, CLK_DOMAIN audio_clk_audio, FREQ_HZ 22580650, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_audio;
  ...
  audio_audio_mono_0_1 audio_mono_1
  ...
  audio_audio_scaler_0_1 audio_scaler_1
       (.din(audio_right_1),
  ...
  audio_sigma_delta_dac_0_1 sigma_delta_dac_1
       (.CLK(clk_audio_1),
