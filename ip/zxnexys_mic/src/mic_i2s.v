...
module mic_i2s
   (clk_audio,
    ...
    m_lrsel,
    reset);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_AUDIO CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_AUDIO, CLK_DOMAIN mic_i2s_clk_audio, FREQ_HZ 22580650, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_audio;
  input i2s_din;
  output i2s_dout;
  output i2s_sclk;
  output i2s_wclk;
