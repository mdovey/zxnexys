...
module mic_i2s
   (clk_12m288,
    ...
    m_lrsel,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_12M288 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_12M288, ASSOCIATED_RESET resetn, CLK_DOMAIN mic_i2s_clk_audio, FREQ_HZ 12280700, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_12m288;
  input i2s_din;
  output i2s_dout;
  output i2s_sclk;
  output i2s_wclk;
