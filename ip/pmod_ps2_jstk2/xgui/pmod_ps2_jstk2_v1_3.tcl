...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PMOD_PS2" -parent ${Page_0}
...
proc update_PARAM_VALUE.PMOD_PS2 { PARAM_VALUE.PMOD_PS2 } {
	# Procedure called to update PMOD_PS2 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PMOD_PS2 { PARAM_VALUE.PMOD_PS2 } {
	# Procedure called to validate PMOD_PS2
	return true
}
